...
Vue.component("purple_header_component_1721931576", {
    template: `
...
<li class="ml-6"><button id="hello-world-button" class="btn-sm text-white bg-purple-600 hover:bg-purple-700 transition duration-150 ease-in-out w-full group relative before:absolute before:inset-0 before:bg-purple-800/30 before:rounded-full before:pointer-events-none"><span class="relative inline-flex items-center">Hello World</span></button></li>
                </ul>
